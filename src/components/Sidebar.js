...
const Sidebar = ({ author, authorFluid }) => (
	<div>
		{
			//here we'll check if we have an author. because if we don't pass an author, the 'author' parameter will be undefined and null, so it means we're in another page.
			author && (
				<Card>
